...
<head>
    ...
    <title>FindLogic BigCommerce App</title>
    <!-- Fonts -->
...
<section class="section">
    <div class="container">
        ...
        <p class="subtitle">
            The AI-powered search that knows users better than they know themselves.
        </p>
        ...
        <div class="box">
            ...
            <form  method="post" action="/config">
                ...
                <div class="field">
                    <div class="control">
                        <label class="checkbox">
                            <input id="fl-status" name="active_status" type="checkbox" @isset($active_status)checked @endisset >
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="fl-shopkey" name="shopkey" class="input" type="text" placeholder="Shopkey" value="@isset($shopkey){{$shopkey}}@endisset">
                    </div>
                </div>
